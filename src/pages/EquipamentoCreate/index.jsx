...
const StyledForm = styled(Form)`
    ...
    .ant-select-selector {
        ...
        .ant-select-selection-search-input { height: 42px !important; }
        .ant-select-selection-placeholder { line-height: 42px !important; }
    }
                ...
                <HeroInner>
                    ...
                    <HeroActions>
                        ...
                        <PrimaryBtn onClick={() => form.submit()} disabled={isSubmitting}>
                            <FiSave /> {isSubmitting ? 'Salvando...' : 'Salvar Equipamento'}
                        </PrimaryBtn>
                    </HeroActions>
                </HeroInner>
            </Hero>
                        ...
                        <StyledForm form={form} layout="vertical" onFinish={handleSubmit}>
                            <Row gutter={[16, 0]}>
                                <Col xs={24} md={12}>
                                    ...
                                    >
                                        <Input placeholder="Ex: Trator, Colheitadeira, Implemento..." maxLength={50} />
                                    </Form.Item>
                                </Col>
                                <Col xs={24} md={12}>
                                    <Form.Item
                                    ...
                                    >
                                        <Input placeholder="Ex: John Deere 6110J, Case IH 2388..." maxLength={100} />
                                    </Form.Item>
                                </Col>
                                <Col xs={24} md={12}>
                                    <Form.Item name="numeroSerieChassi" label="Número de Série / Chassi">
                                        <Input placeholder="Digite o número de série ou chassi" maxLength={50} />
                                    </Form.Item>
                                </Col>
                                <Col xs={24} md={12}>
                                    <Form.Item
                                        ...
                                        rules={[
                                            { pattern: /^\d+(\.\d+)?$/, message: 'Digite um número válido (ex: 100 ou 100.5)' }
                                        ]}
                                    >
